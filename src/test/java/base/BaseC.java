...
public class BaseC {
			...
			//sendkeys
			public void type1(WebElement element , String text) {
				element.sendKeys(text);
			}
			...
			private void implicitlyWait(Duration seconds){
			...
			public String getData(String sheetname,int rownum,int cellnum) throws IOException {
				String res = null;
				File file = new File("C:\\Users\\jeyam\\OneDrive\\Desktop\\Datas1.xlsx");
